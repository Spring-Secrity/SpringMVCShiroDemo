...
<html lang="zh-cn">
    <head>
        ...
        <link   rel="icon" href="${basePath}/statics/images/favicon.ico" type="image/x-icon" />
		<link   rel="shortcut icon" href="${basePath}/statics/images/favicon.ico" />
        <!-- CSS -->
        <link rel="stylesheet" href="${basePath}/statics/css/login/reset.css"/>
        <link rel="stylesheet" href="${basePath}/statics/css/login/supersized.css"/>
        <link rel="stylesheet" href="${basePath}/statics/css/login/style.css"/>
    ...
    <body id="body">
        ...
        <!-- Javascript -->
        <script  src="${basePath}/statics/js/common/jquery/jquery1.8.3.min.js"></script>
        <script  src="${basePath}/statics/js/common/MD5.js"></script>
        <script  src="${basePath}/statics/js/common/supersized.3.2.7.min.js"></script>
        <script  src="${basePath}/statics/js/common/supersized-init.js"></script>
		<script  src="${basePath}/statics/js/common/layer/layer.js"></script>
        <script >
